    ...
    <div class="col-span-full xl:col-auto">
        ...
        <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 sm:p-6">
            ...
            <div class="mb-4">
                ...
                <select id="settings-language" name="countries" class="bg-gray-50 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                ...
                <ul class="divide-y divide-gray-200">
                    <li class="py-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <a href="#" class="block text-sm font-normal truncate text-primary-700 hover:underline">
                                    www.facebook.com/themesberg
                                </a>
                            </div>
                            <div class="inline-flex items-center">
                                <a href="#" class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300">Disconnect</a>
                            </div>
                        </div>
                    </li>
                    <li class="py-4">
                    ...
                    <li class="py-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="inline-flex items-center">
                                <a href="#" class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300">Connect</a>
                            </div>
                        </div>
                    </li>
                    <li class="pt-4 pb-6">
                    ...
                    <li class="py-4">
                        <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                            ...
                            <div class="inline-flex items-center w-auto xl:w-full 2xl:w-auto">
                                <a href="#" class="w-full px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300">Disconnect</a>
                            </div>
                        </div>
                    </li>
                    <li class="py-4">
    ...
    <div class="col-span-2">
        ...
        <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 sm:p-6">
            <div class="flow-root">
                ...
                <ul class="divide-y divide-gray-200">
                    <li class="py-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="inline-flex items-center">
                                <a href="#" class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300">Revoke</a>
                            </div>
                        </div>
                    </li>
                    <li class="pt-4 pb-6">
                ...
                <div>
                    <button class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">See more</button>
                </div>
            </div>
        </div>
    </div>
