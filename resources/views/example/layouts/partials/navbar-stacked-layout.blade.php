        ...
        <div class="flex justify-between items-center max-w-screen-2xl mx-auto">
            <div class="flex justify-start items-center">
                <a href="{{ url('/') }}" class="flex mr-14">
                    ...
                    <span class="self-center hidden sm:flex text-2xl font-semibold whitespace-nowrap">Flowbite</span>
                </a>
                <!-- Desktop menu -->
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1">
                    <ul class="flex flex-col mt-4 space-x-6 text-sm font-medium lg:flex-row xl:space-x-8 lg:mt-0">
                        <li>
                            <a href="#" class="block rounded text-primary-700" aria-current="page">Home</a>
                        </li>
                        <li>
                            <a href="#" class="block text-gray-700 hover:text-primary-700">Messages</a>
                        </li>
                        <li>
                            <a href="#" class="block text-gray-700 hover:text-primary-700">Profile</a>
                        </li>
                        <li>
                            <a href="#" class="block text-gray-700 hover:text-primary-700">Settings</a>
                        </li>
                        <li>
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex justify-between items-center py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 md:w-auto md:dark:hover:bg-transparent">Dropdown <svg class="ml-1 w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></button>
                            <!-- Dropdown menu -->
                            <div id="dropdownNavbar" class="hidden z-20 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow">
                                <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                  <li>
                                    <a href="#" class="block py-2 px-4 hover:bg-gray-100">Item 1</a>
                                  </li>
                                  <li>
                                    <a href="#" class="block py-2 px-4 hover:bg-gray-100">Item 2</a>
                                  </li>
                                  <li>
                                    <a href="#" class="block py-2 px-4 hover:bg-gray-100">Item 3</a>
                                  </li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="flex justify-between items-center lg:order-2">
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg" id="apps-dropdown">
                    ...
                    <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 group">
                        <svg aria-hidden="true" class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg>
                    ...
                    <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 group">
                        <svg aria-hidden="true" class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm0 2h10v7h-2l-1 2H8l-1-2H5V5z" clip-rule="evenodd"></path></svg>
                    ...
                    <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 group">
                        <svg aria-hidden="true" class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z"></path><path fill-rule="evenodd" d="M3 8h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm5 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
    ...
    <nav class="bg-white">
        ...
        <ul id="toggleMobileMenu" class="hidden flex-col mt-0 pt-16 w-full text-sm font-medium lg:hidden">
            <li class="block border-b">
                <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 lg:hover:underline lg:px-0" aria-current="page">Home</a>
            </li>
            <li class="block border-b">
                <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 lg:hover:underline lg:px-0">Messages</a>
            </li>
            <li class="block border-b">
                <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 lg:hover:underline lg:px-0">Profile</a>
            </li>
            <li class="block border-b">
                <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 lg:hover:underline lg:px-0">Settings</a>
            </li>
            <li class="block border-b">
                <button type="button" data-collapse-toggle="dropdownMobileNavbar" class="flex justify-between items-center py-3 px-4 w-full text-gray-900 lg:py-0 lg:hover:underline lg:px-0">Dropdown <svg class="w-6 h-6 text-gray-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg></button>
                <ul id="dropdownMobileNavbar" class="hidden"> 
                    <li class="block border-t border-b">
                        <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 lg:hover:underline lg:px-0">Item 1</a>
                    </li>
                    <li class="block border-b">
                        <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 lg:hover:underline lg:px-0">Item 2</a>
                    </li>
                    <li class="block">
                        <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 lg:hover:underline lg:px-0">Item 3</a>
                    </li>
                </ul>
            </li>
        </ul>
