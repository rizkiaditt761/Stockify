...
<aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
  <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200">
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200">
        <ul class="pb-2 space-y-2">
          ...
          <li>
            <a href="{{ url('/example') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
          ...
          <li>
            ...
            <ul id="dropdown-layouts" class="py-2 space-y-2 {{ Request::is('layouts/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ url('example/layouts/stacked') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
                  {{ Request::is('example/layouts/stacked') ? 'bg-gray-200' : '' }}">
                  Stacked
                </a>
              </li>
              <li>
                <a href="{{ url('example/layouts/sidebar') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
                  {{ Request::is('example/layouts/sidebar/*') ? 'bg-gray-200' : '' }}">
                  Sidebar
                </a>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ url('example/crud/products') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
                  {{ Request::is('crud/products') ? 'bg-gray-200' : '' }}">
                  Products
                </a>
              </li>
              <li>
                <a href="{{ url('example/crud/users') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
                {{ Request::is('example/crud/users') ? 'bg-gray-200' : '' }}">
                Users
              </a>
              </li>
            </ul>
          ...
          <li>
            <a href="{{ url('example/settings') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group {{ $page_slug == 'settings' ? 'bg-gray-100' : '' }}">
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              <li>
                <a href="{{ url('example/pages/pricing/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Pricing</a>
              </li>
              <li>
                <a href="{{ url('example/pages/maintenance/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Maintenance</a>
              </li>
              <li>
                <a href="{{ url('example/pages/404/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">404 not found</a>
              </li>
              <li>
                <a href="{{ url('example/pages/500/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">500 server error</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul id="dropdown-auth" class="hidden py-2 space-y-2">
              <li>
                <a href="{{ url('example/authentication/sign-in') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Sign in</a>
            </li>
            <li>
                <a href="{{ url('example/authentication/sign-up') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Sign up</a>
            </li>
            <li>
                <a href="{{ url('example/authentication/forgot-password') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Forgot password</a>
            </li>
            <li>
                <a href="{{ url('example/authentication/reset-password') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Reset password</a>
            </li>
            <li>
                <a href="{{ url('example/authentication/profile-lock') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Profile lock</a>
            </li>
            </ul>
          </li>
          <li>
            ...
            <ul id="dropdown-playground" class="space-y-2 py-2 {{ Request::is('playground/*') ? 'block' : 'hidden' }}">
              <li>
                  <a href="{{ url('example/playground/stacked') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11">
                      Stacked
                  </a>
              </li>
              <li>
                <a href="{{ url('example/playground/sidebar') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11
                {{ Request::is('example/playground/sidebar') ? 'bg-gray-200' : '' }}">
                    Sidebar
                </a>
            </li>
          </ul>
    ...
    <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex" sidebar-bottom-menu>
      ...
      <a href="{{ url('example/settings/') }}" data-tooltip-target="tooltip-settings" class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100">
